...
from models.experimental.pi0_5.reference.torch_suffix import SuffixEmbedding as SuffixEmbeddingTorch
from models.experimental.pi0_5.tt.ttnn_suffix import SuffixEmbeddingTTNN, convert_suffix_weights_to_ttnn
