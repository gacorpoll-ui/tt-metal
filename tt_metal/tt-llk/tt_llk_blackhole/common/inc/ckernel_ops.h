...
#define TT_OP_SFPLOAD(lreg_ind, instr_mod0, sfpu_addr_mode, dest_reg_addr) \
    TT_OP(0x70, (((lreg_ind) << 20) + (static_cast<unsigned int>(instr_mod0) << 16) + ((sfpu_addr_mode) << 13) + ((dest_reg_addr) << 0)))
#define TT_SFPLOAD_VALID(lreg_ind, instr_mod0, sfpu_addr_mode, dest_reg_addr)                                                                 \
    (ckernel::is_valid(lreg_ind, 4) && ckernel::is_valid(static_cast<unsigned int>(instr_mod0), 4) && ckernel::is_valid(sfpu_addr_mode, 3) && \
     ckernel::is_valid(dest_reg_addr, 13))
...
#define TT_OP_SFPLOADMACRO(lreg_ind, instr_mod0, sfpu_addr_mode, dest_reg_addr) \
    TT_OP(0x93, (((lreg_ind) << 20) + (static_cast<unsigned int>(instr_mod0) << 16) + ((sfpu_addr_mode) << 13) + ((dest_reg_addr) << 0)))
...
#define TT_OP_SFPSTORE(lreg_ind, instr_mod0, sfpu_addr_mode, dest_reg_addr) \
    TT_OP(0x72, (((lreg_ind) << 20) + (static_cast<unsigned int>(instr_mod0) << 16) + ((sfpu_addr_mode) << 13) + ((dest_reg_addr) << 0)))
