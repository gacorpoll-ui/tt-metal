...
#ifdef INP_FLOAT32
            sfpi::dst_reg[out_off] = calculate_i1_asymptotic_(abs_x, x);
#else
            sfpi::dst_reg[out_off] =
                sfpi::float_to_fp16b(calculate_i1_asymptotic_(abs_x, x), sfpi::RoundMode::NearestEven);
#endif
        }
        v_endif;
