...
template <bool APPROXIMATE, ckernel::BinaryOp BINOP, bool is_fp32_dest_acc_en, int ITERATIONS = SFPU_ITERATIONS>
inline void llk_math_eltwise_binary_sfpu_binop_div(
    ...
    _llk_math_eltwise_binary_sfpu_params_<APPROXIMATE>(
        ckernel::sfpu::calculate_sfpu_binary_div<APPROXIMATE, BINOP, is_fp32_dest_acc_en>,
        0,
        ITERATIONS,
        dst_index0,
        dst_index1,
