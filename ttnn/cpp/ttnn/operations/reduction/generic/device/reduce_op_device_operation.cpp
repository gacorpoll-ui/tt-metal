...
void ReduceDeviceOperation::validate_on_program_cache_miss(
    ...
    // INT32 MAX/MIN/SUM are supported via dedicated SFPU compute kernels. (reduce_sfpu.cpp +
    // compute_kernel_lib::reduce_sfpu); the generic FPU GMPOOL path only accepts
    // {FLOAT32, BFLOAT16, BFLOAT8_B, UINT32} and is wrong for INT32 MIN/MAX/SUM.
    const bool is_int32_sfpu_supported =
