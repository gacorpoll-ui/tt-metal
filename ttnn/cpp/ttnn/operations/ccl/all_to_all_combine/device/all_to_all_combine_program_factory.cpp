...
AllToAllCombineDeviceOperation::AllToAllCombineFromSparse::Resources
AllToAllCombineDeviceOperation::AllToAllCombineFromSparse::prepare_resources(
...
tt::tt_metal::ProgramDescriptor AllToAllCombineDeviceOperation::AllToAllCombineFromSparse::create_descriptor(
    const operation_attributes_t& operation_attributes,
    const tensor_args_t& tensor_args,
    tensor_return_value_t& tensor_return_value,
    ...
    TT_FATAL(
        ...
        "AllToAllCombineFromSparse::create_descriptor requires a mesh dispatch coordinate");
    const ttnn::MeshCoordinate mesh_coordinate = mesh_dispatch_coordinate.value();

    const auto& init_semaphore = workload_resources.init_semaphore.value();
    const auto& cross_device_semaphore = workload_resources.cross_device_semaphore.value();
