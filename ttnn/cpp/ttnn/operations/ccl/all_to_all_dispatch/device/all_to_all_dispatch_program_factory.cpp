...
AllToAllDispatchDeviceOperation::AllToAllDispatchSparse::Resources
AllToAllDispatchDeviceOperation::AllToAllDispatchSparse::prepare_resources(
...
tt::tt_metal::ProgramDescriptor AllToAllDispatchDeviceOperation::AllToAllDispatchSparse::create_descriptor(
    const operation_attributes_t& operation_attributes,
    const tensor_args_t& tensor_args,
    tensor_return_value_t& tensor_return_value,
    ...
    TT_FATAL(
        ...
        "AllToAllDispatchSparse::create_descriptor requires a mesh dispatch coordinate");
