...
void py_module(nb::module_& mod) {
    nb::class_<SDPAProgramConfig>(mod, "SDPAProgramConfig")
        .def(
            ...
            nb::arg("global_q_scheduling") = false)
        ...
        .def_rw("global_q_scheduling", &SDPAProgramConfig::global_q_scheduling)
        .def("__repr__", [](const SDPAProgramConfig& config) {
            return fmt::format(
                "SDPAProgramConfig(compute_with_storage_grid_size={}, sub_core_grids={}, q_chunk_size={}, "
                "k_chunk_size={}, exp_approx_mode={}, max_cores_per_head_batch={}, global_q_scheduling={})",
