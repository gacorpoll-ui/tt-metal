...
1. **TensixDataMovementOnePacketReadSizes** (Test ID: 920) - Quasar variant of One Packet Read Sizes.
2. **TensixDataMovementOnePacketWriteSizes** (Test ID: 921) - Quasar variant of One Packet Write Sizes.
