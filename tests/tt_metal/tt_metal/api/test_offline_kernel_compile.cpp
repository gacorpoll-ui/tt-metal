...
TEST_F(MeshDeviceFixture, RuntimePrecompiledHitWithCbMetadataLoadsWithoutJit) {
    ...
    CircularBufferConfig metadata_cb_config(kPageSize, {{0, kCbFormat}});
    metadata_cb_config.set_page_size(0, kPageSize);
    ...
    CircularBufferConfig runtime_cb_config(kPageSize, {{0, kCbFormat}});
    runtime_cb_config.set_page_size(0, kPageSize);
